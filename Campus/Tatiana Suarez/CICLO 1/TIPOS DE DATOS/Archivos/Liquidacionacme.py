...
def agregar(emp):
    ...
    while True:
        ...
        emp.write(f"{ced};{nomb};{horas};{vHora}\n")
        empleados[ced] = {}
...
emp=open("emplacme.dat", "w+",encoding="utf-8")
emp.write("ID;NOMBRE;HORASTRAB;VALHORA\n")
...
while True:
    ...
    if op == 1:
        ...
        lisEmpleados = agregar(emp)
    elif op == 2:
        cc = buscarEmpleado(lisEmpleados)
        modificarEmpleado(lisEmpleados,cc)        
    elif op == 3:
        cc = buscarEmpleado(lisEmpleados)
